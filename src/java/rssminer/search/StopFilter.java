...
public class StopFilter extends FilteringTokenFilter {
    ...
    static {
        final List<String> stopWords = Arrays.asList("an", "and", "are",
                ...
                "are", "around", "as", "aside", "ask", "asking",
                ...
                "beyond", "both", "brief", "but", "by", "c", "came", "can",
                ...
                "could", "course", "currently", "d", "definitely",
                "described", "despite", "did", "different", "do", "does",
                "doing", "done", "down", "downwards", "during", "e", "each",
                ...
                "much", "must", "my", "myself", "n", "name", "namely", "nd",
                ...
                "u", "un", "under", "unfortunately", "unless", "unlikely",
                "until", "unto", "up", "upon", "us", "use", "used", "useful",
                "uses", "using", "usually", "uucp", "v", "value", "various",
                "very", "via", "viz", "vs", "w", "want", "wants", "was",
                "way", "we", "welcome", "well", "went", "were", "what",
